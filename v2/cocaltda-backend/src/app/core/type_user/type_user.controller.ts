					...
					.then(async () => {
						...
						if (!validationStatus) {
							...
							if (url == '/create') {
								...
								const id_company: any = type_user.company;
							...
							} else if (url.substring(0, 19) == '/byProfileQueryRead') {
								const id_profile: any = type_user.profile;
								...
								const id_type_user: any = type_user.id_type_user;
