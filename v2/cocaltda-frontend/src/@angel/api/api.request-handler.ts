...
import { AngelApiReplyCallback } from './api.types';

export class AngelApiHandler {
  request!: HttpRequest<any>;
  urlParams!: { [key: string]: string };

  // Private
  private _reply: AngelApiReplyCallback = undefined;
   ...
   * @param callback
   */
  reply(callback: AngelApiReplyCallback): void {
    // Store the reply
