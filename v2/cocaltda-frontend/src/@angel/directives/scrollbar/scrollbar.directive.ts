 ...
 */
@Directive({
  selector: '[angelScrollbar]',
  exportAs: 'angelScrollbar',
})
export class AngelScrollbarDirective implements OnChanges, OnInit, OnDestroy {
  /* eslint-disable @typescript-eslint/naming-convention */
  static ngAcceptInputType_angelScrollbar: BooleanInput;
  /* eslint-enable @typescript-eslint/naming-convention */

  @Input() angelScrollbar: boolean = true;
  @Input() angelScrollbarOptions!: PerfectScrollbar.Options;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    // Enabled
    if ('angelScrollbar' in changes) {
      // Interpret empty string as 'true'
      this.angelScrollbar = coerceBooleanProperty(
        changes.angelScrollbar.currentValue
      );

      // If enabled, init the directive
      if (this.angelScrollbar) {
        this._init();
      }
    ...
    // Scrollbar options
    if ('angelScrollbarOptions' in changes) {
      // Merge the options
      this._options = merge(
        {},
        this._options,
        changes.angelScrollbarOptions.currentValue
      );
