...
export class AngelNavigationService {
  private _componentRegistry: Map<string, any> = new Map<string, any>();
  private _navigationStore: Map<string, AngelNavigationItem[]> = new Map<
    string,
    any
  >();
   ...
   * @param navigation
   */
  storeNavigation(key: string, navigation: AngelNavigationItem[]): void {
    // Add to the store
   ...
   * @param key
   */
  getNavigation(key: string): AngelNavigationItem[] {
   ...
   */
  getFlatNavigation(
    navigation: AngelNavigationItem[],
    flatNavigation: AngelNavigationItem[] = []
  ): AngelNavigationItem[] {
  ...
  getItemParent(
    id: string,
    navigation: AngelNavigationItem[],
    parent: AngelNavigationItem[] | AngelNavigationItem
  ): AngelNavigationItem[] | AngelNavigationItem | null {
    for (const item of navigation) {
      if (item.id === id) {
        return parent;
      }
