...
@Component({
  selector: 'angel-vertical-navigation-collapsable-item',
  templateUrl: './collapsable.component.html',
  animations: angelAnimations,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AngelVerticalNavigationCollapsableItemComponent
  implements OnInit, OnDestroy
{
  ...
  @HostBinding('class') get classList(): any {
    return {
      'angel-vertical-navigation-item-collapsed': this.isCollapsed,
      'angel-vertical-navigation-item-expanded': this.isExpanded,
    };
  }
  ...
  ngOnInit(): void {
    ...
    this._angelVerticalNavigationComponent.onCollapsableItemCollapsed
    ...
    if (this.autoCollapse) {
      this._angelVerticalNavigationComponent.onCollapsableItemExpanded
        .pipe(takeUntil(this._unsubscribeAll))
  ...
  collapse(): void {
    ...
    this._angelVerticalNavigationComponent.onCollapsableItemCollapsed.next(
      this.item
    );
  }
  ...
  expand(): void {
    ...
    // Execute the observable
    this._angelVerticalNavigationComponent.onCollapsableItemExpanded.next(
      this.item
    );
  }
