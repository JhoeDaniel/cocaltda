...
import { AngelHighlightService } from './highlight.service';

@Component({
  selector: 'textarea[angel-highlight]',
  templateUrl: './highlight.component.html',
  styleUrls: ['./highlight.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  exportAs: 'angelHighlight',
})
export class AngelHighlightComponent implements OnChanges, AfterViewInit {
  @Input() code!: string;
  @Input() lang!: string;
  ...
  constructor(
    ...
    private _angelHighlightService: AngelHighlightService,
  ...
  private _highlightAndInsert(): void {
    ...
    this.highlightedCode = this._domSanitizer.sanitize(
      ...
      this._angelHighlightService.highlight(this.code, this.lang)
    )!;
