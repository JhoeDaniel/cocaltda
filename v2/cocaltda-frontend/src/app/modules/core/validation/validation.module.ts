...
import { ModalSelectTypeValidationComponent } from './modal-select-type-validation/modal-select-type-validation.component';
import { ModalSelectValidationComponent } from './modal-select-validation/modal-select-validation.component';
import { ValidationComponent } from './validation.component';
import { validationRoutes } from './validation.routing';
import { ModalValidationsComponent } from './modal-validations/modal-validations.component';
...
@NgModule({
  declarations: [
    ...
    ValidationComponent,
    ModalSelectValidationComponent,
    ModalSelectTypeValidationComponent,
    ModalValidationsComponent,
