...
export class ModalValidationComponent implements OnInit {
   ...
   */
  ngOnInit(): void {
    this.id_Validation = this._data.id_Validation;
    /**
     * isOpenModal
     */
    ...
    this._validationService
      .specificReadInLocal(this.id_Validation)
      .pipe(takeUntil(this._unsubscribeAll))
      .subscribe();
    /**
     * Get the validations
   ...
   */
  closeModalValidation(): void {
    this._modalValidationService.closeModalValidation();
  }
}
